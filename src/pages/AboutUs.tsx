...
export default function AboutUs() {
    ...
    return (
        <div className='bg-linear-to-b from-ince-gray2 to-white'>
            <section id='Nosotros' className="max-w-5/6 xl:max-w-3/4 mx-auto pt-24">
                ...
                <section className="py-12 md:py-36">
                    <div className="mx-auto px-6 grid lg:grid-cols-2 gap-16">
