...
export default function ServicesStack() {
  ...
  return (
    <section id="Servicios" className="pt-10 bg-linear-to-t from-ince-gray2 to-white">
        ...
        <div className="max-w-5/6 xl:max-w-3/4 mx-auto rounded-3xl overflow-hidden border border-black/10">
